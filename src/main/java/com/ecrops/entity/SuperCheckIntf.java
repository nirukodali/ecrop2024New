...
public class SuperCheckIntf {
	...
	public SuperCheckIntf(String mname, String dao_allotted, String dao_approved, String dao_rejected,
			String ada_allotted, String ada_approved, String ada_rejected, String mao_allotted, String mao_approved,
			String mao_rejected, String dho_allotted, String dho_approved, String dho_rejected, String ho_allotted,
			String ho_approved, String ho_rejected, String rdo_allotted, String rdo_approved, String rdo_rejected,
			String tah_allotted, String tah_approved, String tah_rejected, String jc_allotted, String jc_approved,
			String jc_rejected, String dc_allotted, String dc_approved, String dc_rejected, String hod_allotted,
			String hod_approved, String hod_rejected) {
		super();
		this.mname = mname;
	...
	public String toString() {
		return "SuperCheckIntf [mname=" + mname + ", dao_allotted=" + dao_allotted + ", dao_approved=" + dao_approved
				+ ", dao_rejected=" + dao_rejected + ", ada_allotted=" + ada_allotted + ", ada_approved=" + ada_approved
				+ ", ada_rejected=" + ada_rejected + ", mao_allotted=" + mao_allotted + ", mao_approved=" + mao_approved
				+ ", mao_rejected=" + mao_rejected + ", dho_allotted=" + dho_allotted + ", dho_approved=" + dho_approved
				+ ", dho_rejected=" + dho_rejected + ", ho_allotted=" + ho_allotted + ", ho_approved=" + ho_approved
				+ ", ho_rejected=" + ho_rejected + ", rdo_allotted=" + rdo_allotted + ", rdo_approved=" + rdo_approved
				+ ", rdo_rejected=" + rdo_rejected + ", tah_allotted=" + tah_allotted + ", tah_approved=" + tah_approved
				+ ", tah_rejected=" + tah_rejected + ", jc_allotted=" + jc_allotted + ", jc_approved=" + jc_approved
				+ ", jc_rejected=" + jc_rejected + ", dc_allotted=" + dc_allotted + ", dc_approved=" + dc_approved
				+ ", dc_rejected=" + dc_rejected + ", hod_allotted=" + hod_allotted + ", hod_approved=" + hod_approved
