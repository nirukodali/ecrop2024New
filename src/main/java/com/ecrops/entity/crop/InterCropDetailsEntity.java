...
public class InterCropDetailsEntity {
	...
	public InterCropDetailsEntity() {

	}

	public InterCropDetailsEntity(BigDecimal kh_no, String cr_sno, int bookingid, String cr_farmeruid,
			BigDecimal tot_extent, String oc_name, String oc_fname, String cropname, String varietyname,
			...
			BigDecimal cr_year, char cr_season, String cr_no, String mname, String vname, int wsrcid, int cr_sow_type,
			char cropseed_schme, int id) {
	...
	public String toString() {
		return "InterCropDetailsEntity [kh_no=" + kh_no + ",cr_sno=" + cr_sno + ", bookingid=" + bookingid
				...
				+ ", cr_crop=" + cr_crop + ", variety=" + variety + ", cr_dist_code=" + cr_dist_code + ", cr_mand_code="
				+ cr_mand_code + ", cr_year=" + cr_year + ", cr_season=" + cr_season + ", cr_no=" + cr_no + ", mname="
				+ mname + ", vname=" + vname + ", wsrid=" + wsrcid + ", cr_sow_type=" + cr_sow_type
				+ ", cropseed_schme=" + cropseed_schme + ", id=" + id + "]";
	}
