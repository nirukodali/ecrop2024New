...
@Entity
@Table
public class CropBookingDetailsDhoIntf {
@Id
@GeneratedValue( strategy = GenerationType.AUTO)
	...
	public CropBookingDetailsDhoIntf() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CropBookingDetailsDhoIntf(String bookingid, String oc_name, String cr_farmeruid, String oc_fname,
	...
	public String toString() {
		return "CropBookingDetailsDhoIntf [bookingid=" + bookingid + ", oc_name=" + oc_name + ", cr_farmeruid="
