...
@Entity
@Table
public class Rep_Auth_cropwise_Entity {
	...
	public String toString() {
		return "Rep_Auth_cropwise_Entity [wbdname=" + wbdname + ", wbmname=" + wbmname + ", totalbookings="
	...
	public Rep_Auth_cropwise_Entity(String wbdname, String wbmname, BigDecimal totalbookings, BigDecimal totfarmercount,
	...
	public Rep_Auth_cropwise_Entity() {
		super();
