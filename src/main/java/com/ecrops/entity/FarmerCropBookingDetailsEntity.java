...
@Entity
@Table
public class FarmerCropBookingDetailsEntity {
@Id
@GeneratedValue( strategy = GenerationType.AUTO)
	...
	public FarmerCropBookingDetailsEntity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public FarmerCropBookingDetailsEntity(Integer bookingid, String wbemname, String wbvname, String oc_name,
			String cr_farmeruid, String oc_fname, String owner_tenant, String kh_no, String cr_sno, String cropname,
			String varietyname, String cr_mix_unmix_ext, String cr_sow_date, String cropnature, String watersource,
	...
	public String toString() {
		return "FarmerCropBookingDetailsEntity [bookingid=" + bookingid + ", wbemname=" + wbemname + ", wbvname="
				+ wbvname + ", oc_name=" + oc_name + ", cr_farmeruid=" + cr_farmeruid + ", oc_fname=" + oc_fname
				+ ", owner_tenant=" + owner_tenant + ", kh_no=" + kh_no + ", cr_sno=" + cr_sno + ", cropname="
				+ cropname + ", varietyname=" + varietyname + ", cr_mix_unmix_ext=" + cr_mix_unmix_ext
				+ ", cr_sow_date=" + cr_sow_date + ", cropnature=" + cropnature + ", watersource=" + watersource
				+ ", irrmethoddesc=" + irrmethoddesc + ", photo=" + photo + ", getClass()=" + getClass()
