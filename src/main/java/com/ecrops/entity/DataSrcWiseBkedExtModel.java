...
public class DataSrcWiseBkedExtModel {
	...
	public DataSrcWiseBkedExtModel(String wbdcode, String wbedname, String wbmcode, String wbemname, String web_farmers,
			String web_ext, String nweb_farmers, String nweb_ext, String ccrc_farmers, String ccrc_ext,
			String rofr_farmers, String rofr_ext, String usus_farmers, String usus_ext) {
		super();
		this.wbdcode = wbdcode;
		this.wbedname = wbedname;
		this.wbmcode = wbmcode;
	...
	public DataSrcWiseBkedExtModel() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "DataSrcWiseBkedExtModel [wbdcode=" + wbdcode + ", wbedname=" + wbedname + ", wbmcode=" + wbmcode
				+ ", wbemname=" + wbemname + ", web_farmers=" + web_farmers + ", web_ext=" + web_ext + ", nweb_farmers="
				+ nweb_farmers + ", nweb_ext=" + nweb_ext + ", ccrc_farmers=" + ccrc_farmers + ", ccrc_ext=" + ccrc_ext
				+ ", rofr_farmers=" + rofr_farmers + ", rofr_ext=" + rofr_ext + ", usus_farmers=" + usus_farmers
				+ ", usus_ext=" + usus_ext + "]";
	}
