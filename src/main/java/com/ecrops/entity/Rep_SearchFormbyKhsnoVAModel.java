...
public class Rep_SearchFormbyKhsnoVAModel {
...
private String	  cr_w_draw;
private String	  cr_irr_type;
private String	  wtr_tax;
...
public Rep_SearchFormbyKhsnoVAModel() {
	super();
	// TODO Auto-generated constructor stub
}


public Rep_SearchFormbyKhsnoVAModel(String bookingid, String dcode, String mcode, String cr_dist_code, String wbvname,
		String wbmname, String cr_vcode, String cr_year, String cr_season, String cr_farmeruid, String owner_tenant,
		String oc_name, String oc_fname, String mobileno, String age, String email, String kh_no, String cr_sno,
		String tot_extent, String cultivable_land, String uncultivable_land, String cr_month, String cr_sow_type,
		String cr_crop, String cr_mix_unmix_ext, String cr_no, String cr_w_draw, String cr_irr_type, String wtr_tax,
		String longitude, String latitude, String cropname, String data_src, String varietyname) {
	super();
...
public String getCr_w_draw() {
	return cr_w_draw;
}


public void setCr_w_draw(String cr_w_draw) {
	this.cr_w_draw = cr_w_draw;
}


public String getCr_irr_type() {
	return cr_irr_type;
}


public void setCr_irr_type(String cr_irr_type) {
	this.cr_irr_type = cr_irr_type;
}


public String getWtr_tax() {
	return wtr_tax;
}


public void setWtr_tax(String wtr_tax) {
	this.wtr_tax = wtr_tax;
}
...
public String toString() {
	return "Rep_SearchFormbyKhsnoVAModel [bookingid=" + bookingid + ", dcode=" + dcode + ", mcode=" + mcode
			+ ", cr_dist_code=" + cr_dist_code + ", wbvname=" + wbvname + ", wbmname=" + wbmname + ", cr_vcode="
			+ cr_vcode + ", cr_year=" + cr_year + ", cr_season=" + cr_season + ", cr_farmeruid=" + cr_farmeruid
			+ ", owner_tenant=" + owner_tenant + ", oc_name=" + oc_name + ", oc_fname=" + oc_fname + ", mobileno="
			+ mobileno + ", age=" + age + ", email=" + email + ", kh_no=" + kh_no + ", cr_sno=" + cr_sno
			+ ", tot_extent=" + tot_extent + ", cultivable_land=" + cultivable_land + ", uncultivable_land="
			+ uncultivable_land + ", cr_month=" + cr_month + ", cr_sow_type=" + cr_sow_type + ", cr_crop=" + cr_crop
			+ ", cr_mix_unmix_ext=" + cr_mix_unmix_ext + ", cr_no=" + cr_no + ", cr_w_draw=" + cr_w_draw
			+ ", cr_irr_type=" + cr_irr_type + ", wtr_tax=" + wtr_tax + ", longitude=" + longitude + ", latitude="
			+ latitude + ", cropname=" + cropname + ", data_src=" + data_src + ", varietyname=" + varietyname + "]";
}
