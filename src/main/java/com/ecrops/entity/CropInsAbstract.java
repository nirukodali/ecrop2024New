...
public class CropInsAbstract {
	...
	public CropInsAbstract() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CropInsAbstract(String district, String mandal, String rbkname, BigDecimal yb_farmers, BigDecimal yb_extent,
	...
	public String toString() {
		return "CropInsAbstract [district=" + district + ", mandal=" + mandal + ", rbkname=" + rbkname + ", yb_farmers="
				+ yb_farmers + ", yb_extent=" + yb_extent + ", yb_claimamt=" + yb_claimamt + ", wb_farmers="
				+ wb_farmers + ", wb_extent=" + wb_extent + ", wb_claimamt=" + wb_claimamt + "]";
	}
