...
public class RepVaaFinalListModel {
...
private String	  mao_unlock_appr;
...
public String getMao_unlock_appr() {
	return mao_unlock_appr;
}
public void setMao_unlock_appr(String mao_unlock_appr) {
	this.mao_unlock_appr = mao_unlock_appr;
}
public String getSclength() {
	return sclength;
}
public void setSclength(String sclength) {
...
public RepVaaFinalListModel(String cr_no, String cultdesc_loclang, String cultdesc, String ftype_short,
		String varietyname, String occupname, String occupfname, String sdate, String data_src, String wbdname,
		String wbmname, String wbvname, String kh_no, String bookingid, String vaaauth, String vroauth, String ekyc,
		String naturedesc, String mao_unlock_appr, String sclength, String cr_farmeruid, String seed_production,
		String cr_sno, String cr_mix_unmix_ext, String cropins, String cropname, String wsrcdesc, String cropduration,
		String ins_scheme, String smsmobileno, String supercheck_userid, String irrmethod) {
	super();
	this.cr_no = cr_no;
	this.cultdesc_loclang = cultdesc_loclang;
	this.cultdesc = cultdesc;
...
public RepVaaFinalListModel() {
	super();
	// TODO Auto-generated constructor stub
}
@Override
public String toString() {
	return "RepVaaFinalListModel [cr_no=" + cr_no + ", cultdesc_loclang=" + cultdesc_loclang + ", cultdesc=" + cultdesc
			+ ", ftype_short=" + ftype_short + ", varietyname=" + varietyname + ", occupname=" + occupname
			+ ", occupfname=" + occupfname + ", sdate=" + sdate + ", data_src=" + data_src + ", wbdname=" + wbdname
			+ ", wbmname=" + wbmname + ", wbvname=" + wbvname + ", kh_no=" + kh_no + ", bookingid=" + bookingid
			+ ", vaaauth=" + vaaauth + ", vroauth=" + vroauth + ", ekyc=" + ekyc + ", naturedesc=" + naturedesc
			+ ", mao_unlock_appr=" + mao_unlock_appr + ", sclength=" + sclength + ", cr_farmeruid=" + cr_farmeruid
			+ ", seed_production=" + seed_production + ", cr_sno=" + cr_sno + ", cr_mix_unmix_ext=" + cr_mix_unmix_ext
			+ ", cropins=" + cropins + ", cropname=" + cropname + ", wsrcdesc=" + wsrcdesc + ", cropduration="
			+ cropduration + ", ins_scheme=" + ins_scheme + ", smsmobileno=" + smsmobileno + ", supercheck_userid="
			+ supercheck_userid + ", irrmethod=" + irrmethod + "]";
}
