...
public class CropnamesFCWR {
		...
		public CropnamesFCWR() {
			
		}

		public CropnamesFCWR(int cropid, String cropname, String cropnameeng) {
			super();
			this.cropid = cropid;
		...
		public String toString() {
			return "CropnamesFCWR [cropid=" + cropid + ", cropname=" + cropname + ", cropnameeng=" + cropnameeng
					+ "]";
		}
