...
@Repository
public class Cr_authdetails_mand_cropwise_v_syearFfekycmRepository {
    ...
    public List<Cr_authdetails_mand_cropwise_v_syearFfekycm> getCropwise(int dcode,String sescrpyear,int cropid) {
        ...
        List<Cr_authdetails_mand_cropwise_v_syearFfekycm> list = new ArrayList<>();

        for (Object[] bean : result) {
        	Cr_authdetails_mand_cropwise_v_syearFfekycm crAuthDetails = new Cr_authdetails_mand_cropwise_v_syearFfekycm();
