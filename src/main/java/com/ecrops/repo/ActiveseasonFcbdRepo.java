...
import com.ecrops.entity.ActiveseasonFcbd;

@Repository
public interface ActiveseasonFcbdRepo extends JpaRepository<ActiveseasonFcbd, String> {
	...
	List<ActiveseasonFcbd> getCropyear();
