...
public interface CrEmployeeProfileRepository extends JpaRepository<CrEmpProfileEntity, String> {
    ...
    @Query(value="select a.emp_code, emp_name from ecrop2024.cr_emp_profile a, ecrop2024.emp_rbk_map b where a.dcode=b.dcode and a.mcode=b.mcode and a.emp_code=b.empcode and b.rbkcode=:rbkcode and a.cr_dist_code=:wbdcode2 and a.cr_mand_code=:wbmcode2",nativeQuery=true)
