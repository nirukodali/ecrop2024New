...
import com.ecrops.entity.ActiveseasonFsfbkasno;

@Repository
public interface ActiveseasonFsfbkasnoRepo extends JpaRepository<ActiveseasonFsfbkasno,String>{
	...
	@Query(value="select distinct on (a.cropyear,a.season) concat(a.season,'@',cropyear) as seasonvalue,concat(b.seasonname,' ',cropyear) as cropyear,a.season "
	 ...
	 List<ActiveseasonFsfbkasno>  getCropyear();
