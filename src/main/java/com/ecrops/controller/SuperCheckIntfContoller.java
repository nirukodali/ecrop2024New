...
@Controller
public class SuperCheckIntfContoller {
	...
	@GetMapping("/superCheckIntf")
	public String superCheckForm(Model model, HttpSession httpSession) {
		...
		return "maoroles/superCheckIntf";
	}

	@PreAuthorize("hasAuthority('44') || hasAuthority('45') || hasAuthority('9') || hasAuthority('19')|| hasAuthority('31') || hasAuthority('2') || hasAuthority('5') || hasAuthority('46') || hasAuthority('22')")
	@PostMapping("/getDataSuperCheckIntf")
	public String getDataSuperCheckIntf(@RequestParam("cropyear") @NotBlank String cropyear,
...
//			System.out.println("cropYear--->" + cropYear);
		...
		return "redirect:/viewAfterFormSubmissionIntf";
	}

	@PreAuthorize("hasAuthority('44') || hasAuthority('45') || hasAuthority('9') || hasAuthority('19')|| hasAuthority('31') || hasAuthority('2') || hasAuthority('5') || hasAuthority('46') || hasAuthority('22')")
	@RequestMapping("/viewAfterFormSubmissionIntf")
	public String viewAfterFormSubmission(HttpSession httpSession, Model model) {
		...
		return "maoroles/checksuperIntf";
	}
