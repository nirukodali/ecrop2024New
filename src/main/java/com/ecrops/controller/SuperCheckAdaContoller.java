...
@Controller
public class SuperCheckAdaContoller {
	...
	@PreAuthorize("hasAuthority('44') || hasAuthority('45') || hasAuthority('9') || hasAuthority('19') || hasAuthority('46') || hasAuthority('31') || hasAuthority('2') || hasAuthority('5') || hasAuthority('22')")
	@GetMapping("/superCheckAda")
	public String getSuperCheckAdaEntry(Model model, HttpSession httpSession) {
		...
		return "maoroles/superCheckAdaIntf";
	}

	@PreAuthorize("hasAuthority('44') || hasAuthority('45') || hasAuthority('9') || hasAuthority('19') || hasAuthority('46') || hasAuthority('31') || hasAuthority('2') || hasAuthority('5') || hasAuthority('22')")
	@PostMapping("/dataSuperCheckAda")
	public String handleFormSubmission(@RequestParam("cropyear") @NotBlank String cropyear,
...
//			System.out.println("cropYear--->" + cropYear);
		...
		return "redirect:/viewAfterFormSubmission";
	}

	@PreAuthorize("hasAuthority('44') || hasAuthority('45') || hasAuthority('9') || hasAuthority('19') || hasAuthority('46') || hasAuthority('31') || hasAuthority('2') || hasAuthority('5') || hasAuthority('22')")
	@RequestMapping("/viewAfterFormSubmission")
	public String viewAfterFormSubmission(HttpSession httpSession, Model model) {
		...
		return "maoroles/check_superIntfByAda";
	}
