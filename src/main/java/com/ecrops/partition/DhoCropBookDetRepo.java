...
@Repository
@Transactional
public class DhoCropBookDetRepo {

	@PersistenceContext
	private EntityManager entityManager;

	public List<DhoCropDetEntity> getdhoCropBookingDetails(String wbdcode,String dcode, String mcode,String cropyear) {
        ...
        if (seasonYear.equals(2023) || seasonYear.equals(2024)) {
		...
		List<DhoCropDetEntity> detailsEntities = new ArrayList<DhoCropDetEntity>();

		try {
			for (Object[] row : detailsEntities1) {
				DhoCropDetEntity entity = new DhoCropDetEntity();
