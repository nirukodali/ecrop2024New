...
@Service
public class RepPerFrwdDetServiceImpl implements RepPerFrwdDetService {
	
//	RepPerFrwdDetService
	@PersistenceContext
	private EntityManager entitymanager;
	
	@Override
	public List<RepPerFrwdDetModel> getPerFrwdDet(String tab, String tab2, Integer vcode1) {
		// TODO Auto-generated method stub
	       String  sql = " select oc_name,oc_fname,bookingid,varietyname,cropname,cr_mix_unmix_ext,kh_no,cr_sno,cr_sow_date from " + tab + " "
                   + " where cr_vcode=? and (cr_vcode,cr_sno,kh_no) in (select cr_vcode,cr_sno,kh_no from " + tab2 + " "
